...
> [WSL interop](https://learn.microsoft.com/en-us/windows/wsl/wsl-config#interop-settings)
> must be disabled or else builds for Windows hosts will fail with an "Cannot
> determine executable suffix" error.
