...
set(CMAKE_C_COMPILER \${CMAKE_CURRENT_LIST_DIR}/bin/${TARGET_PREFIX}gcc${SUFFIX})
set(CMAKE_FC_COMPILER \${CMAKE_CURRENT_LIST_DIR}/bin/${TARGET_PREFIX}gfortran${SUFFIX})
set(CMAKE_ASM_COMPILER \${CMAKE_CURRENT_LIST_DIR}/bin/${TARGET_PREFIX}gcc${SUFFIX})
set(CMAKE_CXX_COMPILER \${CMAKE_CURRENT_LIST_DIR}/bin/${TARGET_PREFIX}g++${SUFFIX})
