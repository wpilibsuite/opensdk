...
set(CMAKE_C_COMPILER \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}gcc)
set(CMAKE_CXX_COMPILER \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}g++)
set(CMAKE_Fortran_COMPILER \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}gfortran)

set(CMAKE_AR \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}ar)
set(CMAKE_AS \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}as)
set(CMAKE_NM \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}nm)
set(CMAKE_LINKER \${TOOLCHAIN_BASE_DIR}/bin/${TARGET_PREFIX}ld)
